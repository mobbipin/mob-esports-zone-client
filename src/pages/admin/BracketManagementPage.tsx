...
export const BracketManagementPage: React.FC = () => {
  ...
  const tournament = {
    ...
    participants: 8, // Simplified for demo
    status: "Ongoing",
    format: "Single Elimination"
  };

  // Mock bracket data - simplified 8-team single elimination
    ...
    rounds: [
      {
        ...
        matches: [
          {
            id: 1,
            team1: { name: "Elite Gamers", score: 2 },
            team2: { name: "Storm Breakers", score: 1 },
            winner: "Elite Gamers",
            status: "completed"
          },
          {
          ...
          {
            id: 3,
            team1: { name: "Cyber Knights", score: null },
            team2: { name: "Fire Dragons", score: null },
            winner: null,
            status: "upcoming"
          },
          {
            id: 4,
            team1: { name: "Thunder Bolts", score: null },
            team2: { name: "Ice Wolves", score: null },
            winner: null,
            status: "upcoming"
          }
        ]
      },
      {
        ...
        matches: [
          {
            id: 5,
            team1: { name: "Elite Gamers", score: null },
            team2: { name: "Phoenix Rising", score: null },
            winner: null,
            status: "pending"
          },
          {
        ...
        matches: round.matches.map(match => 
          match.id === selectedMatch.id
            ? {
                ...
                winner: team1Score > team2Score ? match.team1.name : match.team2.name,
                status: "completed"
              }
            : match
        )
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-500">
                    {bracket.rounds.flatMap(r => r.matches).filter(m => m.status === "completed").length} / {bracket.rounds.flatMap(r => r.matches).length}
                  </span>
                </div>
              </div>
            </CardContent>
