...
import { PlusIcon, FileTextIcon, TrophyIcon, UsersIcon, CalendarIcon, TrendingUpIcon, StarIcon, ArrowRightIcon } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="bg-[#15151a] border-[#292932]">
            <CardContent className="p-6">
              ...
              <p className="text-gray-400 mb-6">
                Create and manage your tournaments. All tournaments require admin approval before being visible to players.
              </p>
              <div className="space-y-3">
                ...
                <Link to="/organizer/tournaments">
                  <Button variant="outline" className="w-full border-[#292932] hover:bg-[#292932] text-white">
          ...
          <Card className="bg-[#15151a] border-[#292932]">
            <CardContent className="p-6">
              ...
              <p className="text-gray-400 mb-6">
                Create news posts and announcements. All posts require admin approval before being published.
              </p>
              <div className="space-y-3">
          ...
          <Card className="bg-blue-900/20 border-blue-500/30 mt-6">
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-400 mb-1">Account Pending Approval</h3>
                  <p className="text-blue-300">
                    Your tournament organizer account is pending admin approval. 
                    You can browse the platform but cannot create tournaments or posts until approved.
                  </p>
                </div>
              </div>
            </CardContent>
